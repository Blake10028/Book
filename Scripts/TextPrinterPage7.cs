...
public class TextPrinterPage7 : MonoBehaviour
{
    [SerializeField] private float typingSpeed = 0.10f; // Typing speed in seconds per character
    [SerializeField] private string defaultTextToType = "They walked, and they walked, and they walked. \r\nThey climbed steep hills and wandered under tall trees until they came across a little stump.\r\n \"Fern! Harakeke!\" called Rangiora. \"Are you here?\" \r\nAnd out from the stump came a Fern and Harakeke plant.\r\n";
