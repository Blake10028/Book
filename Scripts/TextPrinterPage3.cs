...
public class TextPrinterPage3 : MonoBehaviour
{
    [SerializeField] private float typingSpeed = 0.10f; // Typing speed in seconds per character
    [SerializeField] private string defaultTextToType = "They walked, and they walked, and they walked. \r\nThey climbed steep hills and wandered under tall trees until [playerName] suddenly fell and scraped their knee.\r\n\"Ow!\" cried [playerName]. \"It's starting to sting.\"\r\nBut Kawakawa knew exactly what to do.\r\n";
