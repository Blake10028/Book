...
public class TextPrinterPage11 : MonoBehaviour
{
    [SerializeField] private float typingSpeed = 0.10f; // Typing speed in seconds per character
    [SerializeField] private string defaultTextToType = "Horopito stared at [playerName], long and hard.\r\n\"Alright, I'll come!\" says Horopito. \"But I'm keeping an eye on you.\"\r\n\"Don't worry about Horopito,\" says Kawakawa to [playerName]. \"They can be a little peppery.\"\r\nAnd off they went to find [playerName]'s home. \r\n";
