...
public class TextPrinterPage5 : MonoBehaviour
{
    [SerializeField] private float typingSpeed = 0.10f; // Typing speed in seconds per character
    [SerializeField] private string defaultTextToType = "Hearing [playerName]'s cries, a Rangiora plant appeared from the forest.\r\n\"Who's this with you, Kawakawa?\" said the taller plant.\r\n";
